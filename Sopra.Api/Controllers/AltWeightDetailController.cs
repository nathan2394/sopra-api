...
namespace Sopra.Api.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class AltWeightDetailController : ControllerBase
    {
        private readonly IServiceAsync<AltWeightDetail> _service;

        public AltWeightDetailController(IServiceAsync<AltWeightDetail> service)
        {
            _service = service;
        }
        ...
        public async Task<IActionResult> Get(int limit = 0, int page = 0, string search = "", string sort = "", string filter = "", string date = "")
        {
            ...
            catch (Exception ex)
            {
                ...
                Trace.WriteLine(message, "AltWeightDetailController");
        ...
        public async Task<IActionResult> GetById(int id)
        {
            try
            {
                ...
                var response = new Response<AltWeightDetail>(result);
                return Ok(response);
            }
            catch (Exception ex)
            {
        ...
        //[Authorize]
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] AltWeightDetail obj)
        {
            try
            {
        ...
        //[Authorize]
        [HttpPut]
        public async Task<IActionResult> Edit([FromBody] AltWeightDetail obj)
        {
            try
            {
