...
namespace Sopra.Api.Controllers
{
    ...
    {
        private readonly IServiceAsync<Customer> _service;

        public CustomerController(IServiceAsync<Customer> service)
        {
            _service = service;
        }
        ...
        public async Task<IActionResult> Get(int limit = 0, int page = 0, string search = "", string sort = "", string filter = "", string date = "")
        {
            ...
            catch (Exception ex)
            {
                ...
                Trace.WriteLine(message, "CustomerController");
        ...
        //[Authorize]
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] Customer obj)
        {
            try
            {
        ...
        //[Authorize]
        [HttpPut]
        public async Task<IActionResult> Edit([FromBody] Customer obj)
        {
            try
            {
