...
namespace Sopra.Api.Controllers
{
    ...
    {
        private readonly IServiceAsync<DeliveryAddress> _service;

        public DeliveryAddressController(IServiceAsync<DeliveryAddress> service)
        {
            _service = service;
        }
        ...
        public async Task<IActionResult> Get(int limit = 0, int page = 0, string search = "", string sort = "", string filter = "", string date = "")
        {
            ...
            catch (Exception ex)
            {
                ...
                Trace.WriteLine(message, "DeliveryAddressController");
        ...
        public async Task<IActionResult> GetById(int id)
        {
            try
            {
                ...
                var response = new Response<DeliveryAddress>(result);
                return Ok(response);
            }
            catch (Exception ex)
            {
        ...
        //[Authorize]
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] DeliveryAddress obj)
        {
            try
            {
        ...
        //[Authorize]
        [HttpPut]
        public async Task<IActionResult> Edit([FromBody] DeliveryAddress obj)
        {
            try
            {
