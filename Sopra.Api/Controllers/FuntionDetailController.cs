...
namespace Sopra.Api.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class FunctionDetailController : ControllerBase
    {
        private readonly IServiceAsync<FunctionDetail> _service;

        public FunctionDetailController(IServiceAsync<FunctionDetail> service)
        {
            _service = service;
        }
        ...
        public async Task<IActionResult> Get(int limit = 0, int page = 0, string search = "", string sort = "", string filter = "", string date = "")
        {
            ...
            catch (Exception ex)
            {
                ...
                Trace.WriteLine(message, "FunctionDetailController");
        ...
        public async Task<IActionResult> GetById(int id)
        {
            try
            {
                ...
                var response = new Response<FunctionDetail>(result);
                return Ok(response);
            }
            catch (Exception ex)
            {
        ...
        //[Authorize]
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] FunctionDetail obj)
        {
            try
            {
        ...
        //[Authorize]
        [HttpPut]
        public async Task<IActionResult> Edit([FromBody] FunctionDetail obj)
        {
            try
            {
