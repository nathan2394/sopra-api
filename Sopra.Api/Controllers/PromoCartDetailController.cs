...
namespace Sopra.Api.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class PromoCartDetailController : ControllerBase
    {
        private readonly IServiceAsync<PromoCartDetail> _service;

        public PromoCartDetailController(IServiceAsync<PromoCartDetail> service)
        {
            _service = service;
        }
        ...
        public async Task<IActionResult> Get(int limit = 0, int page = 0, string search = "", string sort = "", string filter = "", string date = "")
        {
            ...
            catch (Exception ex)
            {
                ...
                Trace.WriteLine(message, "PromoCartDetailController");
        ...
        public async Task<IActionResult> GetById(int id)
        {
            try
            {
                ...
                var response = new Response<PromoCartDetail>(result);
                return Ok(response);
            }
            catch (Exception ex)
            {
        ...
        //[Authorize]
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] PromoCartDetail obj)
        {
            try
            {
        ...
        //[Authorize]
        [HttpPut]
        public async Task<IActionResult> Edit([FromBody] PromoCartDetail obj)
        {
            try
            {
