...
namespace Sopra.Api.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class PromoOrderBottleDetailController : ControllerBase
    {
        private readonly IServiceAsync<PromoOrderBottleDetail> _service;

        public PromoOrderBottleDetailController(IServiceAsync<PromoOrderBottleDetail> service)
        {
            _service = service;
        }
        ...
        public async Task<IActionResult> Get(int limit = 0, int page = 0, string search = "", string sort = "", string filter = "", string date = "")
        {
            ...
            catch (Exception ex)
            {
                ...
                Trace.WriteLine(message, "PromoOrderBottleDetailController");
        ...
        public async Task<IActionResult> GetById(int id)
        {
            try
            {
                ...
                var response = new Response<PromoOrderBottleDetail>(result);
                return Ok(response);
            }
            catch (Exception ex)
            {
        ...
        //[Authorize]
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] PromoOrderBottleDetail obj)
        {
            try
            {
        ...
        //[Authorize]
        [HttpPut]
        public async Task<IActionResult> Edit([FromBody] PromoOrderBottleDetail obj)
        {
            try
            {
