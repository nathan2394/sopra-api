...
namespace Sopra.Api.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class SectionCategoryKeyController : ControllerBase
    {
        private readonly IServiceAsync<SectionCategoryKey> _service;

        public SectionCategoryKeyController(IServiceAsync<SectionCategoryKey> service)
        {
            _service = service;
        }
        ...
        public async Task<IActionResult> Get(int limit = 0, int page = 0, string search = "", string sort = "", string filter = "", string date = "")
        {
            ...
            catch (Exception ex)
            {
                ...
                Trace.WriteLine(message, "SectionCategoryKeyController");
        ...
        public async Task<IActionResult> GetById(int id)
        {
            try
            {
                ...
                var response = new Response<SectionCategoryKey>(result);
                return Ok(response);
            }
            catch (Exception ex)
            {
        ...
        //[Authorize]
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] SectionCategoryKey obj)
        {
            try
            {
        ...
        //[Authorize]
        [HttpPut]
        public async Task<IActionResult> Edit([FromBody] SectionCategoryKey obj)
        {
            try
            {
