...
namespace Sopra.Api.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class StockIndicatorController : ControllerBase
    {
        private readonly IServiceAsync<StockIndicator> _service;

        public StockIndicatorController(IServiceAsync<StockIndicator> service)
        {
            _service = service;
        }
        ...
        public async Task<IActionResult> Get(int limit = 0, int page = 0, string search = "", string sort = "", string filter = "", string date = "")
        {
            ...
            catch (Exception ex)
            {
                ...
                Trace.WriteLine(message, "StockIndicatorController");
        ...
        public async Task<IActionResult> GetById(int id)
        {
            try
            {
                ...
                var response = new Response<StockIndicator>(result);
                return Ok(response);
            }
            catch (Exception ex)
            {
        ...
        //[Authorize]
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] StockIndicator obj)
        {
            try
            {
        ...
        //[Authorize]
        [HttpPut]
        public async Task<IActionResult> Edit([FromBody] StockIndicator obj)
        {
            try
            {
