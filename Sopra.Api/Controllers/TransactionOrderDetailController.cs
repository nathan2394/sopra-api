...
namespace Sopra.Api.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class TransactionOrderDetailController : ControllerBase
    {
        private readonly IServiceAsync<TransactionOrderDetail> _service;

        public TransactionOrderDetailController(IServiceAsync<TransactionOrderDetail> service)
        {
            _service = service;
        }
        ...
        public async Task<IActionResult> Get(int limit = 0, int page = 0, string search = "", string sort = "", string filter = "", string date = "")
        {
            ...
            catch (Exception ex)
            {
                ...
                Trace.WriteLine(message, "TransactionOrderDetailController");
        ...
        public async Task<IActionResult> GetById(int id)
        {
            try
            {
                ...
                var response = new Response<TransactionOrderDetail>(result);
                return Ok(response);
            }
            catch (Exception ex)
            {
        ...
        //[Authorize]
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] TransactionOrderDetail obj)
        {
            try
            {
        ...
        //[Authorize]
        [HttpPut]
        public async Task<IActionResult> Edit([FromBody] TransactionOrderDetail obj)
        {
            try
            {
