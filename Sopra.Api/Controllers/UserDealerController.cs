...
namespace Sopra.Api.Controllers
{
    ...
    {
        private readonly IServiceAsync<UserDealer> _service;

        public UserDealerController(IServiceAsync<UserDealer> service)
        {
            _service = service;
        }
        ...
        public async Task<IActionResult> GetById(int id)
        {
            try
            {
                ...
                var response = new Response<UserDealer>(result);
                return Ok(response);
            }
            catch (Exception ex)
            {
        ...
        //[Authorize]
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] UserDealer obj)
        {
            try
            {
        ...
        //[Authorize]
        [HttpPut]
        public async Task<IActionResult> Edit([FromBody] UserDealer obj)
        {
            try
            {
